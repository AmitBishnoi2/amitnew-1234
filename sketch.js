...
var jumpSound , checkPointSound, dieSound,backgroundSound
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(600,windowHeight-30,40,10);
    cloud.y = Math.round(random(windowHeight-80,windowHeight-120));
